...
import 'package:shoping/controller/auth/verifycodesignup_c.dart';
...
class VerifyCodeSiginUp extends StatelessWidget {
  const VerifyCodeSiginUp({super.key});
  @override
  Widget build(BuildContext context) {
    VerifyCodeSiginUpControllerImpl controller = Get.put(VerifyCodeSiginUpControllerImpl());
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
          title: Text(
